...
public class TaskManager {
    ...
    public void createTask(String title, String description, TaskCategory category, PriorityLevel priority,
            ArrayList<Users> assignedUser) {
        Ulid taskId = new Ulid();
        Task newTask = new Task(taskId, title, description, assignedUser, priority, TaskStatus.TO_DO, category,
                NotificationType.NONE, new ArrayList<>(), new ArrayList<>());
    ...
    public void updateTask(String id, String title, String description, TaskCategory category, PriorityLevel priority,
            ArrayList<Users> assignedUser) {
    ...
    public void updateStatus(String id, TaskStatus newStatus) {
        ...
        Task taskToUpdate = Tasks.get(id);
        if (taskToUpdate != null
                && currentUser instanceof Engineer
    ...
    public assignTask(String taskId, String userId) {
        ...
        if (taskToAssign != null && currentUser.getRole().canManageUsers() && userToAssign != null && userToAssign instanceof Engineer) {
